...
export const styles = StyleSheet.create({
  ...
  focusLabel: { color: PALETTE.primary, fontWeight: "900" },
  focusTimer: { color: PALETTE.turquoise, marginTop: 6 },

  focusToggle: { padding: 8, borderRadius: 10 },
  focusToggleOn: { backgroundColor: PALETTE.primary },
  focusToggleOff: { backgroundColor: "#fff", borderWidth: 1, borderColor: PALETTE.border },
  ...
  /* Chat */
  chatRow: { padding: 12, borderRadius: 12, marginVertical: 6, maxWidth: "82%" },
  chatUser: { alignSelf: "flex-end", backgroundColor: "#EAF9F8" },
  chatAI: {
  ...
  focusModeBackground: { backgroundColor: PALETTE.focusOverlay },
  focusModeTop: { backgroundColor: PALETTE.focusOverlay },
});
...
export const focusTimerStyles = StyleSheet.create({
  ...
  modesRow: { flexDirection: "row", gap: 12, marginBottom: 30 },
  ...
  modeText: { color: PALETTE.primary, fontWeight: "700" },
  modeTextActive: { color: PALETTE.card },

  timer: { fontSize: 86, fontWeight: "900", color: PALETTE.textDark, marginVertical: 30 },
  ...
  icon: { color: PALETTE.primary, fontSize: 30, fontWeight: "900" },
});
