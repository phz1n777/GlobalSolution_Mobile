...
export default function CustomDrawerContent(props: any) {
  ...
  return (
    ...
    >
      ...
      {/* TOPO */}
      <View style={[styles.drawerTop, focusOn && styles.focusModeTop]}>
      ...
      <View style={{ paddingVertical: 6 }}>
        ...
        <DrawerItem
          label="IncludIA"
          icon={() => <Feather name="message-square" size={20} color={PALETTE.textDark} />}
          onPress={() => props.navigation.navigate("IncludIA")}
        />
        <DrawerItem
      ...
      <View style={styles.focusRow}>
        <View>
          <Text style={styles.focusLabel}>Modo Foco</Text>
          {focusOn && (
        ...
        <TouchableOpacity
          style={[
            styles.focusToggle,
            focusOn ? styles.focusToggleOn : styles.focusToggleOff,
          ]}
          onPress={async () => {
            ...
            if (u) {
              ...
              u.settings.focusMode = newState;
              await saveUser(u);
            }

            if (newState) props.navigation.navigate("FocusTimer");
          }}
        >
          <Text style={{ color: focusOn ? "#fff" : PALETTE.primary, fontWeight: "800" }}>
            {focusOn ? "Desativar" : "Ativar"}
          </Text>
        </TouchableOpacity>
      </View>
